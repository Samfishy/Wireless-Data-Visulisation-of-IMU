...
/* USER CODE BEGIN PV */
#define PLD_S 12//payload size should be equal to ack_payload size if DPL is not enabled
...
void MFX_Init(void)
{
	  if (MPU_begin(&hi2c1, 0x68, AFSR_4G, GFSR_500DPS, 0.98, 0.004) == 1)
	  {
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  float data[] = {attitude.p,attitude.y,attitude.r};
	  memcpy(dataT, data, sizeof(data));
